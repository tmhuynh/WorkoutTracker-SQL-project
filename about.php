...
<html>
  ...
  <body>
   ...
   <!--
        <li class="navitem"><a href="https://www.t-nation.com/workouts/531-how-to-build-pure-strength">Account</a></li>
   -->
      </ul>
   </nav></center>
    ...
    <main class="home-page">
      ...
      <h2>FAQ</h2>
       ...
       <ul>
          ...
          <li>Navigate to the “account” page and create a new account by entering a username, password, and email.</li>
